...
import { createBooking, getAllBookings, getUserBookings, updateBookingStatus, getBookedSeats } from "../controllers/bookingController.js";
...
bookingRoutes.get("/booked-seats",getBookedSeats);
